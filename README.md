Вот аккуратный, строгий README без пафоса и эмодзи, который хорошо подходит для учебного или тестового проекта.
...
Если хочешь, я могу ещё дать 3 небольших улучшения, которые делают такой проект на порядок сильнее для портфолио (буквально 15 минут работы, но выглядят как production-подход).